...
const Link: React.FC<{
  ...
  ({ children, className, ...props }, ref: React.Ref<HTMLAnchorElement>) => (
    <a
      {...props}
      className={cx(
        'bg-hero whitespace-nowrap rounded-full px-4 py-2 mr-2 text-xl hover:text-hero focus:outline-none focus-visible:text-hero focus-visible:ring-2 focus-visible:ring-hero transition-colors duration-150 focus-visible:duration-0 hover:font-bold hover:drop-shadow hover:shadow-2xl',
        className
      )}
      ref={ref}
    >
